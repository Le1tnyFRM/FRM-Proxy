...
public class SplashScreen extends JFrame {
    ...
    public SplashScreen() throws IOException {
        ...
        setSize(500,380); setLocationRelativeTo(null);
        setUndecorated(false);
        fluidPanel=new FluidPanel(latch, progressPanel);
        JPanel c=new JPanel(new BorderLayout()); c.setBackground(new Color(30,30,30));
    ...
    private static class FluidPanel extends JPanel {
        ...
        FluidPanel(CountDownLatch l, ProgressPanel p){ this.latch=l; this.prog=p; setOpaque(false); setBackground(new Color(30,30,30)); }
        void start(){
        ...
        @Override protected void paintComponent(Graphics g){
            ...
            if(phase==3){
                float f=1-fade; Color bg=new Color(30,30,30);
                g2.setColor(new Color((int)(bg.getRed()*f + 30*(1-f)), (int)(bg.getGreen()*f+30*(1-f)), (int)(bg.getBlue()*f+30*(1-f)))); g2.fillRect(0,0,w,h);
            ...
            gg.setColor(new Color(30,30,30)); gg.fillRect(0,0,w,h);
    ...
    private static class ProgressPanel extends JPanel {
        ...
        ProgressPanel(){ setOpaque(false); setBackground(new Color(30,30,30)); setPreferredSize(new Dimension(getWidth(),34)); }
        @Override protected void paintComponent(Graphics g){
            ...
            Color barBg=new Color(30,30,30);
            if(greying) barBg=new Color(30,30,30);
